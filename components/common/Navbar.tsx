...
export default function Navbar() {
  ...
  return (
    <motion.nav 
      className={`bg-slate-700/95 border-b border-red-400 sticky top-0 z-50 transition-all duration-300 ${scrolled ? 'py-2 shadow-lg' : 'py-3'}`}
      initial={{ y: -100 }}
      animate={{ y: 0 }}
    ...
    >
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div 
            className="md:hidden border-t bg-slate-700/70  border-red-400"
